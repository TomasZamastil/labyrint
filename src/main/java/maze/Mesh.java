...
public class Mesh {
    ...
    public void build() {
        ...
        for (int i=0;i<w.length;i+=4) {
            ...
            quad(v, x1,0,z1, x0,0,z0, x0,h,z0, x1,h,z1, -nx,0,-nz, r*0.6f,g*0.6f,b*0.6f);
        }
    ...
    private static void quad(List<Float> v,
        ...
        vert(v,x0,y0,z0,nx,ny,nz,r,g,b); vert(v,x1,y1,z1,nx,ny,nz,r,g,b); vert(v,x2,y2,z2,nx,ny,nz,r,g,b);
        vert(v,x0,y0,z0,nx,ny,nz,r,g,b); vert(v,x2,y2,z2,nx,ny,nz,r,g,b); vert(v,x3,y3,z3,nx,ny,nz,r,g,b);
    }

    private static void vert(List<Float> v, float x,float y,float z,
            float nx,float ny,float nz, float r,float g,float b) {
        v.add(x);v.add(y);v.add(z);v.add(nx);v.add(ny);v.add(nz);v.add(r);v.add(g);v.add(b);
    }
}
